...
## Stacks
- `A3-StorageStack` — S3 bucket + DynamoDB table (+ GSI)
- `A3-LambdaStack` — the three lambdas
- `A3-ApiStack` — REST API → plotting lambda
- `A3-EventStack` — S3 events → size-tracking lambda
...
1. Open the CloudFormation console → show the 4 stacks (and their creation timestamps).
